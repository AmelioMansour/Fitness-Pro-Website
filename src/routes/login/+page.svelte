...
the account isnt already registered -->
		...
		<input type="text" bind:value={firstName} placeholder="Enter first name" id="firstNameInput" name="first"/>
		<h1 id="nameLabel">Last Name</h1>
		<input type="text" bind:value={lastName} placeholder="Enter last name" id="lastNameInput" name="last" />
		<h1 id="usernameLabel">Username</h1>
		<input type="text" bind:value={username} placeholder="Enter username" id="usernameInput" name="user"/>
		<h1 id="passwordLabel">Password</h1>
		<input type="password" bind:value={password} placeholder="Enter password" id="passwordInput" name="pass"/>
		<br />
